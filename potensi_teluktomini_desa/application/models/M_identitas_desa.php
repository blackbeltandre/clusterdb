...
class M_identitas_desa extends CI_Model
{

    public $table = 'tbl_identitas_desa';
    public $id = 'id_desa';
    public $order = 'DESC';
 ...
 function contoh(){
    ...
    $querydb1= $db2->select('*')->get('tbl_identitas_desa');
    ...
    public function update_desa($data, $id_desa){
        $db2 = $this->load->database('database_kedua', TRUE);
		$db2->where('id_desa', $id_desa);
		$db2->update('tbl_identitas_desa', $data);
