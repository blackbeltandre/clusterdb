                ...
                <table id="example1" class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModalEdit<?php echo $id_pertanian; ?>"><i class="fa fa-edit"></i></button>
                      </a>
                      
                      <a href="<?php echo base_url('data_pertanian/delete/'.$id_pertanian); ?>" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Hapus <?php echo $key->jenis_tanaman; ?> ?')">
